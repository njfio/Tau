...
2. Compute delta from Review #52 baseline (`6f2676ab`) using git history and static scans.
3. Draft `tasks/review-53.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3338/plan.md`
- `specs/3338/tasks.md`
- `specs/milestones/m268/index.md` (issue linkage)
