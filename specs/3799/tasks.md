...
- [x] T1: Add failing gateway integration test proving `/ops/chat/send` needs an assistant reply.
- [x] T2: Reuse Cortex completion/fallback from the ops chat handler.
- [x] T3: Persist assistant reply in the selected session lineage.
- [x] T4: Validate targeted gateway tests.
