...
4. [x] T4 (GREEN): keep shortcut contract metadata non-visible on the live operator surface.
5. [x] T5 (REGRESSION): rerun `spec_2830`, `spec_2834`, `spec_2858`, `spec_2862`, `spec_2866`, `spec_2870`, and `spec_2872` suites.
