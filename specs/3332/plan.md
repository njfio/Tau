...
2. Compute delta from Review #49 baseline (`debf1e83`) using git history and static scans.
3. Draft `tasks/review-50.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3332/plan.md`
- `specs/3332/tasks.md`
- `specs/milestones/m265/index.md` (issue linkage)
