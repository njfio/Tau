...
5. [x] T5 (GREEN): add bounded graph-backed node preview with summaries, navigable relation context, preserved graph-detail return anchors, selected returned-row markers, and out-of-preview recovery on zero-result Memory Explorer pages.
