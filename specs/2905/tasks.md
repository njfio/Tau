...
4. [x] T4 (GREEN): add Memory Scope graph node/edge availability markers for zero-result pages.
5. [x] T5 (REGRESSION): rerun selected chat/session/detail/ops suites (`spec_2802`, `spec_2830`, `spec_2834`, `spec_2838`, `spec_2842`, `spec_2846`, `spec_2885`, `spec_2889`, `spec_2893`, `spec_2897`, `spec_2901`).
6. [x] T6 (VERIFY): run fmt/clippy/scoped tests/mutation + sanitized live validation.
