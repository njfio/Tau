...
5. [x] T5 (GREEN): add bounded graph-backed node preview with summaries, navigable relation context, and preserved graph-detail return anchors on zero-result Memory Explorer pages.
