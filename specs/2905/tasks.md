...
5. [x] T5 (GREEN): add bounded graph-backed node preview with summaries, navigable relation context, preserved graph-detail return anchors, and selected returned-row markers on zero-result Memory Explorer pages.
