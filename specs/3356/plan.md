...
2. Compute delta from Review #61 baseline (`d39fcd85`) using git history and static scans.
3. Draft `tasks/review-62.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3356/plan.md`
- `specs/3356/tasks.md`
- `specs/milestones/m277/index.md` (issue linkage)
