...
2. Compute delta from Review #62 baseline (`18c67272`) using git history and static scans.
3. Draft `tasks/review-63.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3358/plan.md`
- `specs/3358/tasks.md`
- `specs/milestones/m278/index.md` (issue linkage)
