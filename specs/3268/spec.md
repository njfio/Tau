...
| C-02 | AC-1 | Regression/Conformance | password-session request missing password field | `regression_gateway_auth_session_endpoint_rejects_missing_password` | endpoint returns bad-request contract |
| C-03 | AC-1 | Regression/Conformance | password-session request with malformed json | `regression_gateway_auth_session_endpoint_rejects_malformed_json` | endpoint returns malformed-json contract |
