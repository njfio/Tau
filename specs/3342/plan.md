...
2. Compute delta from Review #54 baseline (`3211c578`) using git history and static scans.
3. Draft `tasks/review-55.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3342/plan.md`
- `specs/3342/tasks.md`
- `specs/milestones/m270/index.md` (issue linkage)
