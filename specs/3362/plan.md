...
2. Compute delta from Review #64 baseline (`a405b560`) using git history and static scans.
3. Draft `tasks/review-65.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3362/plan.md`
- `specs/3362/tasks.md`
- `specs/milestones/m280/index.md` (issue linkage)
