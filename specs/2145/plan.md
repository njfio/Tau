...
- Risk: story closure before child artifacts are fully implemented.
  - Mitigation: explicit checks for `#2146` closed/done and implemented child spec statuses.
...
- Child closure checks:
  ...
  `sed -n '1,8p' specs/2146/spec.md specs/2147/spec.md`
- Guard:
