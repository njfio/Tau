...
- Keep edit-entry controls in a compact, collapsed-by-default action manager that preserves deterministic status/form markers.
...
then a deterministic edit form exists inside a collapsed-by-default action manager with stable marker IDs and full-field controls.
...
|---|---|---|---|---|---|
| C-01 | AC-1 | Functional | `/ops/memory` | render memory route | edit manager is collapsed by default and edit form markers/fields are present with deterministic IDs |
