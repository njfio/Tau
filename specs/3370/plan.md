...
2. Compute delta from Review #68 baseline (`f411300f`) using git history and static scans.
3. Draft `tasks/review-69.md` with scale snapshot, change summary, quality posture, and verdict.
...
- `specs/3370/plan.md`
- `specs/3370/tasks.md`
- `specs/milestones/m284/index.md` (issue linkage)
