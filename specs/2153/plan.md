...
Status: Implemented
Spec: specs/2153/spec.md

## Approach

1. Verify child task closure state and implemented child artifacts.
2. Re-run wave-7 rustdoc guard on current `master`.
...
- Risk: story closure before child artifacts are fully implemented.
  - Mitigation: explicit checks for `#2154` closed/done and implemented child spec statuses.
...
- Child checks:
  ...
  `sed -n '1,8p' specs/2154/spec.md specs/2155/spec.md`
- Guard:
