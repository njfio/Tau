...
## Context
Runtime entrypoints still default to `openai/gpt-5.2`, which is no longer
...
## Scope
- Change default model id from `openai/gpt-5.2` to `openai/gpt-5.2` for:
...
- Docs no longer present `openai/gpt-5.2` as recommended default.
