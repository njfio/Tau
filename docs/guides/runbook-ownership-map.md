...
| `docs/guides/m296-ga-readiness-gate.md` | `scripts/verify/m296-ga-readiness-gate.sh`, `scripts/verify/m295-operator-maturity-wave.sh`, `scripts/dev/operator-readiness-live-check.sh`, `scripts/demo/rollback-drill-checklist.sh` | Final integrated M296 GA signoff gate that aggregates RL/auth/readiness/rollback evidence. |
