...
| `docs/guides/m296-ga-readiness-gate.md` | `scripts/verify/m296-ga-readiness-gate.sh`, `scripts/verify/m295-operator-maturity-wave.sh`, `scripts/demo/test-m24-rl-live-benchmark-proof.sh`, `scripts/verify/m296-live-auth-validation.sh`, `scripts/dev/test-operator-readiness-live-check.sh`, `scripts/demo/test-rollback-drill-checklist.sh` | Final integrated M296 GA signoff gate that aggregates RL/auth/readiness/rollback evidence plus RL hardening and live-auth validation. |
