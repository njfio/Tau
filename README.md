...
| E2E scenario-group expansion | deterministic core scenario-depth verification across integration memory/tool paths and gateway lifecycle/session contracts is delivered; full PRD scenario-group completion remains in progress | [`specs/tau-e2e-testing-prd.md`](specs/tau-e2e-testing-prd.md), [`specs/milestones/m298/index.md`](specs/milestones/m298/index.md), [`scripts/verify/m313-e2e-core-scenario-depth.sh`](scripts/verify/m313-e2e-core-scenario-depth.sh) |
