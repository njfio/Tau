...
"#,
    ...
    #[test]
    fn provider_required_tool_choice_contract_claude_prompt_requires_textual_tool_call() {
    ...
    #[test]
    fn provider_tool_choice_matrix_claude_prompt_distinguishes_auto_required_and_named_tool() {
        let auto_prompt = render_claude_prompt(&test_request());
        ...
        let required_prompt = render_claude_prompt(&required_request);
        ...
        let named_prompt = render_claude_prompt(&named_request);
