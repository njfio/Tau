...
"#,
    ...
    #[test]
    fn provider_tool_choice_matrix_codex_prompt_distinguishes_auto_required_and_named_tool() {
        let auto_prompt = render_codex_exec_prompt(&test_request());
        ...
        let required_prompt = render_codex_exec_prompt(&required_request);
        ...
        let named_prompt = render_codex_exec_prompt(&named_request);
