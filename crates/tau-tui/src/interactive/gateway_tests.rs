...
#[test]
fn red_spec_3582_gateway_sse_parser_preserves_response_operator_state_contract() {
...
#[test]
fn red_spec_3582_gateway_response_events_drive_interactive_app_state() {
...
#[test]
fn red_spec_3582_gateway_failed_events_drive_interactive_error_state() {
    let mut app = App::new(app_config());
