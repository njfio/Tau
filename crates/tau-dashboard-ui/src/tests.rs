...
fn functional_spec_3756_c01_harness_route_renders_template_panels() {
    ...
    for marker in [
        ...
        "id=\"tau-ops-harness-history\" data-action=\"history\" data-action-contract=\"context-preserving\" data-preserves-session=\"true\" data-preserves-proposal=\"true\" data-preserves-history-context=\"true\" href=\"/ops/harness?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-044&amp;view=history\"",
...
fn functional_spec_3756_c02_harness_controls_expose_benchmark_and_policy_contracts() {
    ...
    for marker in [
        ...
        "data-proof-source=\"fallback\"",
        "data-latest-result=\"4/4\"",
        "data-proof-visible=\"true\"",
        "Benchmark Proof",
        "data-proof-metric=\"proof-artifact\"><dt>Proof artifact</dt><dd><code>/artifacts/bench/m334/latest.json</code></dd>",
        ...
        "id=\"tau-ops-harness-action-view-diff\" data-action=\"view-diff\" data-action-tone=\"secondary\" href=\"/ops/harness/proposals/PR-044/diff?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-044\"",
...
fn functional_spec_3757_c01_c02_harness_snapshot_drives_benchmark_and_audit_rows() {
    ...
    for marker in [
        ...
        "id=\"tau-ops-harness-benchmark-proof\"",
        "data-proof-artifact=\"/state/ops-harness/m334/latest.json\"",
        "data-proof-source=\"state\"",
        "data-latest-result=\"6/7\"",
        "data-failed-gates=\"1\"",
        "data-proof-metric=\"latest-result\"><dt>Result</dt><dd>6/7</dd>",
...
fn functional_harness_history_view_surfaces_state_audit_summary() {
        ...
        selected_proposal: TauOpsDashboardHarnessProposalDetail {
            ...
            test_evidence_href:
                "/ops/harness/artifacts/view/ops-harness/self-improvement/PR-045/dry-run-result.json"
                    .to_string(),
            test_evidence_label: "ops-harness/self-improvement/PR-045/dry-run-result.json"
                .to_string(),
            ..TauOpsDashboardHarnessProposalDetail::default()
        },
        detail_tool_rows: vec![TauOpsDashboardHarnessToolEvidenceRow {
            ...
            status_key: "passed".to_string(),
            artifact_label: "proof".to_string(),
            artifact_href: "/ops/harness/artifacts/view/ops-harness/m334/latest.json".to_string(),
        }],
        detail_artifact_rows: vec![TauOpsDashboardHarnessArtifactRow {
            item_id: "benchmark-proof".to_string(),
            status_key: "mission_harness_proof".to_string(),
            label: "Benchmark proof artifact".to_string(),
            href: "/ops/harness/artifacts/view/ops-harness/m334/latest.json".to_string(),
        }],
        self_improvement_proof: TauOpsDashboardHarnessSelfImprovementProof {
            source: "state".to_string(),
            mission_id: "ops-harness-self-improve-pr-045".to_string(),
            mission_status: "completed".to_string(),
            artifact_count: 1,
            final_learning_summary: "Applied PR-045 and updated curator state.".to_string(),
            artifact_rows: vec![TauOpsDashboardHarnessProofRow {
                item_id: "apply-result".to_string(),
                status_key: "self-improvement-apply".to_string(),
                label: "ops-harness/self-improvement/PR-045/apply-result.json".to_string(),
            }],
            ..TauOpsDashboardHarnessSelfImprovementProof::default()
        },
        audit_source: "state".to_string(),
    ...
    for marker in [
        ...
        "Audit records loaded for selected proposal PR-045.",
        ...
        "id=\"tau-ops-harness-history\" data-action=\"history\" data-action-contract=\"context-preserving\" data-preserves-session=\"true\" data-preserves-proposal=\"true\" data-preserves-history-context=\"true\" href=\"/ops/harness?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run&amp;audit_ref=1778419944988\"",
        ...
        "id=\"tau-ops-harness-run-benchmark-form\" action=\"/ops/harness/run-benchmark?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=run-benchmark\" method=\"post\"",
        "id=\"tau-ops-harness-approve-form\" action=\"/ops/harness/proposals/PR-045/approve?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=approve\" method=\"post\"",
        "id=\"tau-ops-harness-reject-form\" action=\"/ops/harness/proposals/PR-045/reject?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=reject\" method=\"post\"",
        "id=\"tau-ops-harness-dry-run-form\" action=\"/ops/harness/proposals/PR-045/dry-run?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run\" method=\"post\"",
        "id=\"tau-ops-harness-apply-form\" action=\"/ops/harness/proposals/PR-045/apply?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=apply\" method=\"post\"",
        "id=\"tau-ops-harness-action-view-diff\" data-action=\"view-diff\" data-action-tone=\"secondary\" href=\"/ops/harness/proposals/PR-045/diff?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run&amp;audit_ref=1778419944988\"",
        "data-tool=\"verification_runner\" data-status=\"passed\" data-tool-artifact-href=\"/ops/harness/artifacts/view/ops-harness/m334/latest.json?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run\"",
        "<td><a href=\"/ops/harness/artifacts/view/ops-harness/m334/latest.json?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run\" data-tool-proof-artifact-href=\"true\">proof</a></td>",
        "<a href=\"/ops/harness/artifacts/view/ops-harness/m334/latest.json?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run\">Benchmark proof artifact</a>",
        "<dt>Test Evidence</dt><dd><a href=\"/ops/harness/artifacts/view/ops-harness/self-improvement/PR-045/dry-run-result.json?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run\">ops-harness/self-improvement/PR-045/dry-run-result.json</a></dd>",
        "href=\"/ops/harness/artifacts/view/ops-harness/self-improvement/PR-045/apply-result.json?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-045&amp;view=history&amp;audit_action=dry-run\" data-proof-artifact-href=\"true\" data-proof-artifact-path=\"ops-harness/self-improvement/PR-045/apply-result.json\"",
        "<h5>Proof Preview</h5>",
        "\"proposal_id\": \"PR-045\"",
        ...
        "data-audit-ref=\"1778419944988\" data-audit-selected=\"true\"",
...
fn functional_harness_draft_mission_exposes_start_action() {
    ...
    for marker in [
        ...
        "tau-harness-mission-identity",
        "data-mission-identity=\"mission-draft-123\"",
        "data-visible-proof-id=\"true\"",
        "Proof mission-draft-123",
...
fn functional_harness_mission_rows_link_to_detail_proof() {
    ...
    for marker in [
        ...
        "data-mission-identity=\"mission-completed-123\"",
        "Selected proof mission-completed-123",
        ...
        "data-mission-identity=\"mission-awaiting-456\"",
        "Proof mission-awaiting-456",
...
#[test]
fn functional_harness_selected_mission_detail_controls_tui_summary() {
    let harness = TauOpsDashboardHarnessSnapshot {
        ...
        detail_gate_rows: vec![
            ...
            TauOpsDashboardHarnessProofRow {
                item_id: "VG-EXECUTE".to_string(),
                status_key: "passed".to_string(),
                label: "Coding-agent proof is linked.".to_string(),
            },
            TauOpsDashboardHarnessProofRow {
                item_id: "VG-LEARN".to_string(),
                status_key: "passed".to_string(),
                label: "Final learning output is written.".to_string(),
            },
        ],
        detail_memory_hit_count: 1,
        detail_learning_record_count: 1,
        ..TauOpsDashboardHarnessSnapshot::default()
    };
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        active_route: TauOpsDashboardRoute::Harness,
    ...
    for marker in [
        "id=\"tau-ops-harness-proof-window\" data-window=\"mission-detail-proof-view\" data-window-order=\"2\" data-run-id=\"mission-draft-123\" data-mission-status=\"completed\" data-tool-budget=\"1/40\" data-detail-proof-artifact=\"/state/ops-harness/missions/mission-draft-123/mission.json\"",
        "mission=mission-draft-123",
        "Mission Proof",
        "Acceptance: 3/3",
        "Gates: 3/3 passed",
        ...
        assert!(
            html.contains(marker),
            "selected mission detail should control TUI marker `{marker}`"
        );
    }
}
...
fn functional_spec_3792_c01_c02_c03_harness_proof_pane_fits_in_app_browser_width() {
    ...
    for marker in [
        "id=\"tau-ops-harness-proof-window\" data-window=\"mission-detail-proof-view\" data-window-order=\"2\" data-run-id=\"run_8f3a2\" data-mission-status=\"running\" data-tool-budget=\"42/60\" data-detail-proof-artifact=\"/artifacts/bench/m334/latest.json\" data-window-chrome=\"compact\" data-narrow-proof-fit=\"no-hidden-overflow\"",
...
#[test]
fn functional_spec_2905_c03a_memory_graph_detail_open_memory_preserves_preview_return_anchor() {
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        auth_mode: TauOpsDashboardAuthMode::Token,
    ...
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-detail-open-memory\" href=\"/ops/memory?theme=light&amp;sidebar=collapsed&amp;session=default&amp;workspace_id=&amp;channel_id=&amp;actor_id=&amp;memory_type=&amp;detail_memory_id=mem-b&amp;preview_memory_id=mem-b#tau-ops-memory-graph-preview-row-1\""
    ));
    assert!(html.contains(
        "data-detail-memory-id=\"mem-b\" data-preview-return-memory-id=\"mem-b\" data-preview-return-anchor=\"tau-ops-memory-graph-preview-row-1\""
    ));
}

#[test]
fn functional_spec_2905_c03a_memory_graph_detail_explains_missing_requested_memory() {
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        auth_mode: TauOpsDashboardAuthMode::Token,
        active_route: TauOpsDashboardRoute::MemoryGraph,
        theme: TauOpsDashboardTheme::Light,
        ...
        command_center: TauOpsDashboardCommandCenterSnapshot::default(),
        chat: TauOpsDashboardChatSnapshot {
            memory_detail_requested_entry_id: "mem-z".to_string(),
            memory_graph_node_rows: vec![
                TauOpsDashboardMemoryGraphNodeRow {
                    memory_id: "mem-a".to_string(),
                    summary: "Keep plugin registry hot reload safe".to_string(),
    ...
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-detail-panel\" data-detail-visible=\"false\" data-detail-requested=\"true\" data-detail-state=\"not-found\" data-memory-id=\"\" data-requested-memory-id=\"mem-z\""
    ));
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-detail-summary\" data-memory-id=\"\">Requested memory mem-z was not found in this graph scope."
    ));
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-detail-open-memory\" href=\"/ops/memory?theme=light&amp;sidebar=collapsed&amp;session=default&amp;workspace_id=&amp;channel_id=&amp;actor_id=&amp;memory_type=&amp;detail_memory_id=mem-z&amp;preview_memory_id=mem-z#tau-ops-memory-graph-preview\""
    ));
    assert!(html.contains(
        "data-detail-memory-id=\"mem-z\" data-preview-return-memory-id=\"mem-z\" data-preview-return-anchor=\"tau-ops-memory-graph-preview\""
    ));
}

#[test]
fn functional_spec_2905_c03a_memory_preview_marks_returned_graph_detail_row() {
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        auth_mode: TauOpsDashboardAuthMode::Token,
        active_route: TauOpsDashboardRoute::Memory,
        theme: TauOpsDashboardTheme::Light,
        ...
        command_center: TauOpsDashboardCommandCenterSnapshot::default(),
        chat: TauOpsDashboardChatSnapshot {
            memory_preview_selected_entry_id: "mem-b".to_string(),
            memory_graph_node_rows: vec![
                TauOpsDashboardMemoryGraphNodeRow {
                    memory_id: "mem-a".to_string(),
                    summary: "Keep plugin registry hot reload safe".to_string(),
    ...
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-preview\" data-preview-count=\"2\" data-preview-limit=\"5\" data-node-count=\"2\" data-edge-count=\"0\" data-graph-state=\"graph available\" data-preview-selected-memory-id=\"mem-b\" data-preview-selected-state=\"matched\""
    ));
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-preview-row-0\" data-memory-id=\"mem-a\" data-memory-type=\"goal\" data-importance=\"0.8000\""
    ));
    assert!(html.contains(
        "data-relation-detail-href=\"\" data-preview-selected=\"false\" data-preview-selected-memory-id=\"mem-b\" aria-current=\"false\""
    ));
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-preview-row-1\" data-memory-id=\"mem-b\" data-memory-type=\"fact\" data-importance=\"0.6000\""
    ));
    assert!(html.contains(
        "data-relation-detail-href=\"\" data-preview-selected=\"true\" data-preview-selected-memory-id=\"mem-b\" aria-current=\"true\""
    ));
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-preview-return-badge-1\" data-memory-graph-preview-return-badge=\"mem-b\""
    ));
    assert!(html.contains("Returned from graph detail"));
    assert!(html.contains("#tau-ops-memory-graph-preview-list li[data-preview-selected=\"true\"]"));
}
...
fn functional_spec_2905_c03a_memory_preview_explains_out_of_preview_return() {
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        ...
        chat: TauOpsDashboardChatSnapshot {
            ...
            memory_graph_node_rows: ["a", "b", "c", "d", "e", "z"]
                .iter()
                .map(|suffix| TauOpsDashboardMemoryGraphNodeRow {
                    memory_id: format!("mem-{suffix}"),
                    summary: format!("Memory {suffix} summary"),
                    memory_type: "goal".to_string(),
                    importance: "0.6000".to_string(),
                })
                .collect(),
    ...
    assert!(html.contains(
        "id=\"tau-ops-memory-graph-preview-out-of-preview-link\" href=\"/ops/memory-graph?theme=light&amp;sidebar=collapsed&amp;session=default&amp;workspace_id=&amp;channel_id=&amp;actor_id=&amp;memory_type=&amp;detail_memory_id=mem-z\""
    ));
    ...
    assert!(html.contains("#tau-ops-memory-graph-preview-out-of-preview"));
}

#[test]
fn functional_spec_2905_c03a_memory_preview_explains_not_in_scope_return() {
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        auth_mode: TauOpsDashboardAuthMode::Token,
        active_route: TauOpsDashboardRoute::Memory,
        theme: TauOpsDashboardTheme::Light,
...
fn functional_spec_3086_c02_memory_graph_route_renders_selected_node_detail_panel_contracts() {
    let html = render_tau_ops_dashboard_shell_with_context(TauOpsDashboardShellContext {
        ...
        chat: TauOpsDashboardChatSnapshot {
            ...
            memory_detail_visible: true,
            memory_detail_requested_entry_id: "mem-detail-graph".to_string(),
