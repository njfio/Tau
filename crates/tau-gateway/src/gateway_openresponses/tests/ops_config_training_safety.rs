...
async fn integration_spec_3756_c04_ops_harness_route_renders_benchmark_and_apply_markers() {
    ...
    for marker in [
        ...
        "id=\"tau-ops-harness-history\" data-action=\"history\" data-action-contract=\"context-preserving\" data-preserves-session=\"true\" data-preserves-proposal=\"true\" data-preserves-history-context=\"true\" href=\"/ops/harness?theme=dark&amp;sidebar=expanded&amp;session=ops-harness-contract&amp;proposal_id=PR-044&amp;view=history\"",
...
async fn integration_spec_3757_c03_ops_harness_route_reflects_state_backed_proof_and_audit() {
    ...
    for marker in [
        ...
        "id=\"tau-ops-nav-harness\"><a data-nav-item=\"mission-harness\" href=\"/ops/harness?theme=dark&amp;sidebar=expanded&amp;session=default&amp;proposal_id=PR-044&amp;view=history\" data-harness-rail-label=\"Missions\" data-preserves-shell-context=\"true\" aria-current=\"page\">Mission Harness</a>",
